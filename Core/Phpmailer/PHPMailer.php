...
class PHPMailer
{
     ...
     * $basedir is prepended when handling relative URLs, e.g. <img Phpmailer="/images/a.png"> and must not be empty
    ...
    {
        preg_match_all('/(?<!-)(Phpmailer|background)=["\'](.*)["\']/Ui', $message, $images);
